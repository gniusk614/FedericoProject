						...
						<div class="dataTable-wrapper dataTable-loading no-footer">
							<div class="dataTable-container"
								...
								<table id="table_id" class="table">
									<thead>
										<tr class="lead"
											...
											<td scope="col"
												style="width: 700px; font-size: x-large; font-weight: bold;">${noticeDetail.title}
											</td>
											...
											<td scope="col" style="width: 100px; color: gray;">
											<div style="border-right: 1px solid lightgray;">
											조회수&nbsp;${noticeDetail.cnt}</div></td>
											<td scope="col" style="width: 100px; color: gray;">작성자&nbsp;<b>${noticeDetail.id}</b></td>
										</tr>
									</thead>
								</table>
								<div class="row py-3 px-5"
									...
									<div>
										<pre style="font-size: medium;">${noticeDetail.content}</pre>
									</div>
								</div>
								<div class="row mt-4 px-3">
									<div class="col-6" align="left">
										<button class="btn btn-outline-primary" style="width: 100px;"
											onclick="javascript:location.href='noticeBoardf'">목록</button>
									</div>
									<div class="col-6" align="right">
										<button class="btn btn-outline-primary" style="width: 100px;"
											onclick="javascript:location.href='noticeUpdatef?seq=${noticeDetail.seq}'">
											수정
										</button>
										<button class="btn btn-outline-primary" style="width: 100px;"
											onclick="noticeDelete('${noticeDetail.seq}')">
											삭제
										</button>
									</div>
								</div>
