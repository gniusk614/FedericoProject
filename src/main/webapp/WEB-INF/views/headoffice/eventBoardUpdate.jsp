				...
				<div class="card" id="contentCard">
					<div class="card-header">
						<div class="form-group mb-2">
							<input type="text" id="title" placeholder="제목" value="${eventDetail.title}"
								class="form-control">
							<input type="text" id="eventSeq" placeholder="글번호" value="${eventDetail.eventSeq}" hidden="hidden"
								class="form-control">
						</div>
					</div>
					<div class="card-body">
						...
						<div class="row">							
							<div class="col" align="left">
								<button class="btn btn-primary" onclick="eventUpdate()">수정</button>
								<button class="btn btn-primary" onclick="location.href='eventBoardf'">취소</button>
							</div>
						</div>
					</div>
					</div>
