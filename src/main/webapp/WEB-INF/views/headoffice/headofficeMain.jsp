                        ...
                        <div class="nav">
                           ...
                           <!-- 메인 대쉬보드 -->
                            ...
                            <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">가맹점 정보</a>
                            ...
                            <div class="collapse" id="collapseLayouts3"	 aria-labelledby="headingFour" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                            ...
                            <div class="collapse" id="collapseLayouts4"	 aria-labelledby="headingFour" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="layout-static.html">메뉴조회</a>
                                    <a class="nav-link" href="layout-sidenav-light.html">메뉴등록</a>
				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<div class="collapse" id="collapseLayouts1"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="#" id="staffList">직원정보 조회</a>
							</nav>
							<c:if test="${loginID == 'admin' }">
								<nav class="sb-sidenav-menu-nested nav">
									<a class="nav-link" href="#" id="staffJoinf">직원계정 생성</a>
								</nav>
							</c:if>
						</div>
						<!-- 한덩어리 -->
						...
						<div class="collapse" id="collapseLayouts2"
							...
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="layout-static.html">가맹점 정보</a> <a
									class="nav-link" href="layout-sidenav-light.html">미처리 발주내역</a>
								<a class="nav-link" href="layout-sidenav-light.html">처리완료
									발주내역</a>
							</nav>
						</div>
						<!-- 한덩어리 -->
						...
						<div class="collapse" id="collapseLayouts3"
							...
							<nav class="sb-sidenav-menu-nested nav">
								...
								<a class="nav-link" href="layout-sidenav-light.html">자재조회</a> <a
									class="nav-link" href="layout-sidenav-light.html">자재등록</a>
							</nav>
						</div>
						<!-- 한덩어리 -->
				...
				<div class="container-fluid px-4">
					...
					<div class="row">
						<div class="col-xl-6">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-chart-area me-1"></i> 지역별 피자 선호도 통계
								</div>
								<div class="card-body">
						...
						<div class="col-xl-6">
							<div class="card mb-4">
								<div class="card-header">
									<i class="fas fa-chart-bar me-1"></i> 월별 매출 통계
								</div>
								<div class="card-body">
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> 가맹점 발주 신청현황
						</div>
						<div class="card-body">
							<table id="datatablesSimple">
								<thead>
