				...
				<div class="col-10" align="center">
					<div class="form-group gy-5">
						<div class="input-group mb-4">
							<input type="text" id="clientId" name="clientId"
								class="form-control" value="${clientVO.clientId}" readonly="readonly">
						</div>
					</div>
					<div class="form-group gy-5">
						<div class="input-group mb-4">
							<input type="text" id="clientName" name="clientName"
								class="form-control" value="${clientVO.clientName}" readonly="readonly">
						</div>
					</div>
					<div class="form-group has-success mb-4">
						<button type="button" class="btn btn-outline-danger" onclick="javascript:$('#pwchangeModal').modal('show');"
					...
					<div class="input-group mb-4">
						<input id="clientPhone" name="clientPhone"
							...
							value="${clientVO.clientPhone}">
							<button class="btn btn-outline-danger" type="button"
							id="button-addon2" onclick="javascript:$('#phoneCheckModal_up').modal('show');">휴대폰인증</button>
					</div>
					<div class="input-group mb-4">
					...
					<div class="input-group mb-4">
						<input type="text" class="form-control" id="inputEmail" value="${fn:substringBefore(clientVO.clientEmail, '@')}"
							placeholder="이메일"> <span class="input-group-text">@</span>
						<input id="emailServer" type="text" class="form-control"
							value="${fn:substringAfter(clientVO.clientEmail, '@')}" readonly="readonly"> <select
					...
					<div class="row">
						<div class="input-group mb-2">
							<input id="address" class="form-control" type="text" value="${clientVO.clientAddress}" readonly="readonly">
							<button class="btn btn-outline-danger" type="button"
						...
						<div class="modal-footer">
							<div class="container-fluid">
								<div class="row justify-content-md-center">
									<div class="col-6">
										<input class="btn btn-danger" id="phoneChangeConfirm" type="button" onclick="phonechangeSumit()" style="width: 100%;"
										value="수정" disabled="disabled">
									</div>
									<div class="col-6">
										<button type="button" class="btn btn-secondary infoClose" style="width: 100%;"
					...
					<div class="modal-content">
						...
						<div id="modal-body" class="modal-body">
							...
							<div class="form-group gy-5">
								...
								<div>
									<input class="btn btn-danger" type="button" onclick="pwchangeSumit()"
										value="수정">
									<button type="button" class="btn btn-secondary" onclick="$('#pwchangeModal').modal('hide')">Close</button>
								</div>
							</div>
							</div>
						</div>
