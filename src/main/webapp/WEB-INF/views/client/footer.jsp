...
<footer class="py-5 mt-5 bg-dark" style="height: 168px; position: relative; transform: translateY(-100%);">
		<div>
			...
			<a href="/federico/headoffice/fcloginForm"><span style="color: white;">가맹점 전용 페이지</span></a>&nbsp;&nbsp;
			<a href="/federico/headoffice/loginf"><span style="color: white;">본사전용 페이지</span></a>&nbsp;&nbsp;
		</div>
		<div>
