...
<body>
	...
	<fmt:formatNumber var="now_HH" value="${delivery_ms/1000/60/60}" pattern="00" type="number"/>
	<fmt:formatNumber var="now_mm" value="${delivery_ms/1000/60%60}" pattern="00" type="number"/>
	<div>
	${deliveryTime }
	</div>
	<!-- Section--> 
