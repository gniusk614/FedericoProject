...
//    }
    ...
    // 3) 필요값 계산 -> 메서드 하나로 모두 처리
    // => totalRowCount를 이용해서
    //		spageNo, epageNo, prev, next, lastPageNo
    ...
    // ** ver02 
    // => uri에 search 기능 추가
    // ?currPage=1&rowsPerPage=3&searchType=t&keyword=Java
	...
	public String toString() {
		return "PageMaker [totalRowCount=" + totalRowCount + ", spageNo=" + spageNo + ", epageNo=" + epageNo
				+ ", displayPageNo=" + displayPageNo + ", lastPageNo=" + lastPageNo + ", prev=" + prev + ", next="
				+ next + "]";
	}
